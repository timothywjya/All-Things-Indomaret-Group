...
<form action="{{ $register_url }}" method="post">
    ...
    {{-- Roles field --}}
    <div class="input-group mb-3">
        <select aria-label="Default select example" class="form-select form-control  @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="{{ __('adminlte::adminlte.email') }}">
